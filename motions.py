...
class motion_executioner(Node):
    ...
    def odom_callback(self, odom_msg: Odometry):
        ...
        yaw = euler_from_quaternion(odom_msg.pose.pose.orientation) #not sure which one we are supposed to be implementing in utilities.py, modify as needed
    ...
    def timer_callback(self):
        ...
        self.get_logger().info('something')    
    ...
    def make_spiral_twist(self):
        ...
        msg.angular.z=2.0 #constant rotational speed
        return msg
